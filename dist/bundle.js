...
var _githubScraper = __webpack_require__(8);
...
var uriData = (0, _urijs2.default)().query(true);
var githubId = uriData['github'];
// const gitlabId = uriData['gitlab'];

var ghData = new _githubScraper2.default(githubId);
// const glData = new GitlabScraper(gitlabId);

ghData.getProfile(function (user) {
...
(function (root, factory) {
  ...
  if (typeof module === 'object' && module.exports) {
    ...
    // AMD. Register as an anonymous module.
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(1), __webpack_require__(2), __webpack_require__(3)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
...
var GithubScraper = function () {
  function GithubScraper(id) {
    _classCallCheck(this, GithubScraper);
  ...
  _createClass(GithubScraper, [{
    key: 'getProfile',
    value: function getProfile(fn) {
      var id = this._id;
    ...
    value: function getRepository() {
      var id = this._id;
      var url = 'https://api.github.com/users/' + id + '/repos';
    }
